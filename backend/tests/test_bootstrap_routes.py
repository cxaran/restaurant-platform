...
class BootstrapRoutesTest(unittest.TestCase):
    ...
    def test_catalog_only_before_setup(self) -> None:
        ...
        self.assertEqual([group["name"] for group in body["permission_groups"]], ["users", "roles", "permissions", "system_settings", "backups", "audit_events", "files", "business", "catalog", "shipping", "orders", "payments", "tickets", "deliveries", "finances", "credits", "storefront", "profiles"])
