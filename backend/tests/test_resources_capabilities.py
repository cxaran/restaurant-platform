...
class PermissionsCatalogTest(unittest.TestCase):
    ...
    def test_grouped_catalog_exposes_labels(self) -> None:
        ...
        self.assertEqual(names, ["users", "roles", "permissions", "system_settings", "backups", "audit_events", "files", "business", "catalog", "shipping", "orders", "payments", "tickets", "deliveries", "finances"])
        for group in groups:
